...
rem A candidate only counts if it contains bin\java.exe: a stale or half-deleted jdk-* directory
rem must fall through to the next resolver rather than winning and failing later.
